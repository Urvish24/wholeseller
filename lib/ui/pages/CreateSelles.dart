...
class CreateSelles extends StatefulWidget {
  const CreateSelles({Key key}) : super(key: key);

  @override
  _CreateSellesState createState() => _CreateSellesState();
}

class _CreateSellesState extends State<CreateSelles> {
  ...
  Future<void> apiCall(var btnstop) async {
    ...
    if (_controllerName.text.isEmpty) {
      ...
      Map<String, dynamic> _responseMap = await _contactRepository.createSelles(map)  as Map<String, dynamic>;;
