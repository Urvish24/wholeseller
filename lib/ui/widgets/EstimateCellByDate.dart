...
class EstimateCellByDate extends StatefulWidget {
  var wSellerArray;
  int i;
  GestureTapCallback onTap;
  Function apiReload;

  EstimateCellByDate({this.wSellerArray, this.i, this.apiReload});

  @override
  _EstimateCellByDateState createState() =>
      _EstimateCellByDateState();
}

class _EstimateCellByDateState extends State<EstimateCellByDate> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(
                  widget.wSellerArray['userDetail']['usr_name'],
            ...
            new Expanded(
              child: new TextField(
                ...
                decoration: new InputDecoration(
                    labelText: 'Full Name', hintText: 'Reason of Rejection'),
              ),
            )
          ],
        ),
  ...
  Future<void> ApiCalling(bool approve) async {
    var map;
    if(approve){
      map  = {
